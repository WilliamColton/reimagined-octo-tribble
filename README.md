...
# 2024 8/29日23：25：30留，彻底成功了，成功访问了youtube，呜呜呜呜呜呜呜，感谢v2ex上面 body007 这个用户的主要帮助，以及其他许许多多人的热心指教，还有可可爱爱的女朋友的支持。最终代码在kite_end.zip里面，从此该库改为只读模式。
# 附上一张运行成功后进入youtube的截图。（end.png）
# 几乎所有的问题都来源于加解密QAQ
